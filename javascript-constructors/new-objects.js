...
console.log('value of aString: ', aNumber);

console.log('typeof aString: ', typeof aNumber);

var aBoolean = new Boolean();

console.log('value of aString: ', aBoolean);

console.log('typeof aString: ', typeof aBoolean);
